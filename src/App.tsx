...
function App() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setIsSending(true); // Add this line to show loading
        try {
            ...
            if (response.ok) {
                toast.custom((t) => <CustomToast message="SMS sent successfully!" />, {
    duration: 4000,
  });
            } else {
        ...
        setIsSending(false); // Remove loading
    };
    ...
    useEffect(() => {
        ...
        window.onscroll = () => {
            const current = [...sections].find(sec => window.scrollY >= sec.offsetTop - 100);
            if (current) {
    ...
    return (
        <div className="App font-sans">
            <nav className="sticky top-0 bg-gradient-to-r from-purple-900 via-blue-800 to-black text-white p-4 z-50 flex gap-6 justify-center shadow-md animate__animated animate__fadeInDown">
            ...
            >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center px-4">
                    ...
                    <motion.h1
                        className="text-5xl md:text-6xl font-extrabold text-pink-400 animate__animated animate__fadeIn"
